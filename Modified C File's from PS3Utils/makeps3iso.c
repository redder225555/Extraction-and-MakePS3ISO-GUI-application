...
// Place these struct definitions near the top, after your includes and before any function that uses them
...
#endif
int makeps3iso_entry(int argc, const char* argv[])
{
...
if(argc < 2 && !unattended) printf("\nSplit in 4GB parts? (y/n):\n");
iso_split = (arg_split== 'y' || argc >= 2) ? arg_split : (unattended ? 'n' : get_input_char());
