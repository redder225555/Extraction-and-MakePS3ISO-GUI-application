...
struct iso_primary_descriptor {
    ...
    unsigned char system_id       [ISODCL (  9,  40)];
    unsigned char volume_id       [ISODCL ( 41,  72)];
    unsigned char unused2         [ISODCL ( 73,  80)];
    unsigned char volume_space_size       [ISODCL ( 81,  88)];
    unsigned char unused3         [ISODCL ( 89, 120)];
    unsigned char volume_set_size         [ISODCL (121, 124)];
    unsigned char volume_sequence_number  [ISODCL (125, 128)];
    unsigned char logical_block_size      [ISODCL (129, 132)];
    unsigned char path_table_size         [ISODCL (133, 140)];
    unsigned char type_l_path_table       [ISODCL (141, 144)];
    unsigned char opt_type_l_path_table   [ISODCL (145, 148)];
    unsigned char type_m_path_table       [ISODCL (149, 152)];
    unsigned char opt_type_m_path_table   [ISODCL (153, 156)];
    unsigned char root_directory_record   [ISODCL (157, 190)];
    unsigned char volume_set_id           [ISODCL (191, 318)];
    unsigned char publisher_id            [ISODCL (319, 446)];
    unsigned char preparer_id             [ISODCL (447, 574)];
    unsigned char application_id          [ISODCL (575, 702)];
    ...
    unsigned char file_structure_version  [ISODCL (882, 882)];
...
struct iso_directory_record {
    ...
    unsigned char ext_attr_length   [ISODCL (2, 2)];
    unsigned char extent            [ISODCL (3, 10)];
    unsigned char size              [ISODCL (11, 18)];
    unsigned char date              [ISODCL (19, 25)];
    unsigned char flags             [ISODCL (26, 26)];
    unsigned char file_unit_size    [ISODCL (27, 27)];
    unsigned char interleave        [ISODCL (28, 28)];
    unsigned char volume_sequence_number [ISODCL (29, 32)];
...
int patchps3iso_main(int argc, const char* argv[])
{
    struct stat s;
    int n;
    int a = 0;
    ...
    u32 lba0 = isonum_731(&sect_descriptor.type_l_path_table[0]);
        ...
        while(1) {
            ...
            while(1) {
                ...
                if(idr->length[0]!=0 && (idr->length[0] + q) > 2048) {
                    ...
                    if(!unattended) { printf("Press ENTER key\n"); get_input_char(); }
...
#endif
int patchps3iso_entry(int argc, const char* argv[]) {
    return patchps3iso_main(argc, argv);
}